...
int AdminClient :: PHXEcho( const google::protobuf::StringValue & req,
        google::protobuf::StringValue * resp )
{
    ...
    if(ep != nullptr) {
        ...
        bool open_ret = phxrpc::PhxrpcTcpUtils::Open(&socket, ep->ip, ep->port,
                    global_adminclient_config_.GetConnectTimeoutMS(), NULL, 0, 
...
int AdminClient :: PhxBatchEcho( const google::protobuf::StringValue & req,
        google::protobuf::StringValue * resp )
{
    int ret = -1; 
...
int AdminClient :: RegisterNode( const magna::RegisterNodeRequest & req,
...
int AdminClient :: NodeHeatbeat( const magna::NodeHeartbeatRequest & req,
...
int AdminClient :: RegisterService( const magna::RegisterServiceRequest & req,
...
int AdminClient :: ServiceHeatbeat( const magna::ServiceHeartbeatRequest & req,
