...
void ShowUsage(const char *program) {
    ...
    SimuTool::Name2Func_t *name2func = SimuTool::GetName2Func();

    for (int i{0}; ; ++i) {
        SimuTool::Name2Func_t *iter = &(name2func[i]);
...
int main(int argc, char **argv) {
    ...
    if (nullptr != config) SimuClient::Init(config);

    SimuTool::Name2Func_t *target{nullptr};
    ...
    SimuTool::ToolFunc_t targefunc = target->func;
